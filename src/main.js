...
import { faUsers, faCompass, faClock, faComments, faHome, faPowerOff } from '@fortawesome/free-solid-svg-icons';
...
library.add(faUsers, faCompass, faClock, faComments, faHome, faPowerOff);
